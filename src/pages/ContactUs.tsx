...
function ContactUs() {
  const iconWrapper =
    'group flex items-center justify-center bg-[#38C6C6] p-4 rounded-full hover:bg-white hover:border-2 hover:border-[#38C6C6] transition-colors duration-300';

  const iconStyle =
    'w-10 h-10 text-white group-hover:text-[#38C6C6] transition-colors duration-300';
  return (
    <div>
      <div className="md:flex md:flex-row items-center p-4 md:justify-around justify-center flex flex-col">
        <div className="my-[8%]">
          <h1 className="text-6xl font-oswald font-bold mb-2">
            Contact <span className="text-[#38C6C6]">US</span>
          </h1>
          ...
          <h1 className="text-4xl font-pacifico font-bold mb-2">
            The <span className="text-[#38C6C6]">Socials</span>
          </h1>
